...
class PathEnum:
    ...
    path_instruction_md = dir_package / "instruction.md"
    path_knowledge_base_md = dir_package / "knowledge-base.md"
    ...
    path_suggested_actions_json = dir_project_root / "data" / "suggested_actions.json"
